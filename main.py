...
print(f'num_simulations: {num_simulations}\n'
      f'num_fruits: {num_fruits}\n'
      f'num_raven_winning: {num_raven_winning}\n'
      f'num_fruits_taken_if_dice_shows_basket: {num_fruits_taken_if_dice_shows_basket}\n'
      f'{52 * "-"}')
for strategy in ['max', 'min', 'random']:
    obstgarten_games = [ObstgartenGame(strategy, num_fruits_taken_if_dice_shows_basket, num_fruits, num_raven_winning)
